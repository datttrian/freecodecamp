  ...
  var l = [
    ...
    m = (function (t) {
      ...
      function n(t) {
        ...
        return (
          e(this, n),
          ((r = o.call(this, t)).state = { padStyle: u }),
            ...
            value: function () {
              this.props.power
                ? 'orange' === this.state.padStyle.backgroundColor
                  ? this.setState({ padStyle: u })
                  : this.setState({ padStyle: p })
      ...
      return (
        r(n, [
          ...
          },
          {
            ...
            value: function () {
              var e = this,
                t = this.state.power ? { float: 'right' } : { float: 'left' },
                r =
                  this.state.currentPadBank === l
                    ? { float: 'left' }
                    : { float: 'right' }
              return (
                [].slice
                  .call(document.getElementsByClassName('clip'))
                  .forEach(function (t) {
